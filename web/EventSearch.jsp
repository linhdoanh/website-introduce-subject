<%-- 
    ...
    Created on : Apr 1, 2022, 2:31:04 PM
    Author     : PC
--%>
...
<html style="font-size: 16px;">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/EventSearch.css" media="screen">
                            ...
                            <div class="menu-collapse u-custom-font u-font-roboto-slab" style="font-size: 1rem; letter-spacing: 0px; font-weight: 700;">
                              ...
                              <div class="u-custom-menu u-nav-container">
                                <ul class="u-custom-font u-font-roboto-slab u-nav u-spacing-30 u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-radius-10 u-text-active-custom-color-2 u-text-grey-90 u-text-hover-custom-color-2" href="HomePageServlet" style="padding: 18px 10px;">TRANG CHỦ</a>
                                    ...
                                    </li><li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-radius-10 u-text-active-custom-color-2 u-text-grey-90 u-text-hover-custom-color-2 active" href="events" style="padding: 18px 10px;">SỰ KIỆN</a>
                                    </li></ul>
                            </div>
            ...
            <div class="u-align-left u-clearfix u-sheet u-valign-middle u-sheet-1">
                <div class="u-list u-list-1">
                    <div class="u-repeater u-repeater-1">
                        <c:set var="listCateEvent" value="${requestScope.LIST_CATE_EVENTS}"/>
                        <c:forEach items="${listCateEvent}" var="lce">
                            <div class="u-align-center u-border-2 u-border-black u-border-no-bottom u-border-no-left u-border-no-top u-container-style u-list-item u-repeater-item u-shape-rectangle u-list-item-1">
                                <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-1">
                                    <h5 class="u-text u-text-1">
                                        <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-1" href="eventsCategory?eid=${lce.id}" >${lce.name}</a>
                                    </h5>
                                </div>
                            </div>
                        </c:forEach>
<!--                        <div class="u-align-center u-border-2 u-border-black u-border-no-bottom u-border-no-left u-border-no-top u-container-style u-list-item u-repeater-item u-shape-rectangle u-list-item-2">
                            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-2">
                                <h5 class="u-text u-text-2">
                                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-2" href="NewsSearch.jsp" >SỰ KIỆN MỚI</a>
                                </h5>
                            </div>
                        </div>-->
<!--                        <div class="u-align-center u-border-2 u-border-black u-border-no-bottom u-border-no-left u-border-no-top u-container-style u-list-item u-repeater-item u-shape-rectangle u-list-item-3">
                            <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-3">
                                <h5 class="u-text u-text-3">
                                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-3" href="NewsSearch.jsp" >SỰ KIỆN CŨ</a>
                                </h5>
                            </div>
                        </div>-->
                    </div>
                        ...
                        <div class="u-layout-col">
                            <div class="u-size-20">
                                <div class="u-layout-row">
                                    <c:set var="listEventById" value="${requestScope.LIST_CATE_EVNETS_ID}"/>
                                    <c:forEach items="${listEventById}" var="lei">
                                        <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                                            <div class="u-container-layout u-container-layout-1">
                                                <h3 class="u-text u-text-1">
                                                    <a href="detailEvents?eid=${lei.id}" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-1" >${lei.title}</a>
                                                    <br>
                                                    <span style="font-weight: 400; font-size: 1.25rem;">${lei.des}</span>
                                                    <br>
                                                </h3>
                                            </div>
                                        </div>
...
<!--                                    <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                                        <div class="u-container-layout u-valign-top u-container-layout-2">
                                            <h3 class="u-text u-text-2">
                                                <a href="Event2.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-2" >Webinar “Future Foundation” mùa thứ 2 với chủ đề Virtualization</a>
                                                <br>
                                                <span style="font-weight: 400; font-size: 1.25rem;">Webinar “Future Foundation” là chuỗi hội thảo cung cấp những kiến thức nền tảng và thực tế về lập trình...</span>
                                                <br>
                                            </h3>
                                        </div>
                                    </div>-->
...
<!--                                    <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-3">
                                        <div class="u-container-layout u-container-layout-3">
                                            <h3 class="u-text u-text-3">
                                                <a href="Event3.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-3" >Chính thức khởi động cuộc thi lập trình Zoohackthon Vietnam 2021</a>
                                                <br>
                                                <span style="font-weight: 400; font-size: 1.25rem;">Đây là nơi hội tụ và kết nối của tất cả các bạn sinh viên tài năng và nhiệt huyết từ các trường đại học...</span>
                                                <br>
                                            </h3>
                                        </div>
                                    </div>-->
...
<!--                                        <div class="u-container-layout u-valign-top u-container-layout-4">
                                            <h3 class="u-text u-text-4">
                                                <a href="Event4.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-4" >FPT Uni Secathon mùa 4 chính thức quay trở lại</a>
                                                <br>
                                                <span style="font-size: 1.25rem; font-weight: 400;"></span>
                                                <span style="font-size: 1.25rem; font-weight: 400;">Là sân chơi kiến thức chuyên sâu về bảo mật máy tính...</span>
                                                <br>
                                            </h3>
                                        </div>-->
                                    </div>
                                    ...
                                    <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-5">
                                        <div class="u-container-layout u-valign-top u-container-layout-5">
                                            <h3 class="u-text u-text-5">
                                                <a href="Event5.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-5" >Career Talk: Cơ hội thực tập tại FPT Software dành cho sinh viên ĐH FPT<br>
                                                </a>
                                                <span style="font-weight: 400; font-size: 1.25rem;"></span>
                                                <span style="font-weight: 400; font-size: 1.25rem;">Bạn muốn tìm cho mình cơ hội thực tập và làm việc trong một môi trường chuyên nghiệp...</span>
                                                <br>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-6">
                                        <div class="u-container-layout u-container-layout-6">
                                            <h3 class="u-text u-text-6">
                                                <a href="Event6.jsp" class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-active-custom-color-1 u-text-black u-text-hover-custom-color-9 u-btn-6" >Cùng sinh viên trường F đi tìm lời giải cho câu hỏi: “How to get started in UI/UX Design?”</a>
                                                <br>
                                                <span style="font-weight: 400; font-size: 1.25rem;">Với mong muốn giúp sinh viên ngành Công nghệ thông tin có cái nhìn rõ hơn về UI/UX...</span>
